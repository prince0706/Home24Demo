...
class SwipeableCardViewContainer: UIView, SwipeableViewDelegate {
	...
	func nextArticle(withDirection dragDirection: SwipeDirection) {
		if let cardView = visibleCardViews.last {
			cardView.goToNext(withDirection: dragDirection)
		}
	}
...
extension SwipeableCardViewContainer {
    ...
    func didEndSwipe(onView view: SwipeableView) {
		...
		if let cardView = view as? SwipeableCardViewCard, let index = cardViews.index(of: cardView) {
			delegate?.cardDirection(card: cardView, atIndex: index)
		}
